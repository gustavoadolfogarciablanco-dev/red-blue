...
const translations = {
  es: {
    ...
    'hero.title':               'Menos procesos manuales.<br /><em>Más crecimiento.</em>',
    'hero.subtitle':            'Cada día sin la tecnología correcta es dinero que se va. Nosotros lo resolvemos: desarrollo, cloud, automatización y diseño que realmente entregan resultados.',
  ...
  en: {
    ...
    'hero.title':               'Fewer manual processes.<br /><em>More growth.</em>',
    'hero.subtitle':            'Every day without the right technology is revenue lost. We deliver: software, cloud, automation and design that actually move the needle.',
